...
public class BasuraVentanaRoto extends BasuraVidrio {
    public BasuraVentanaRoto(double x, double y, double width, double height, double hitboxSize) {
        super(x, y, width, height, hitboxSize);
    }

    public BasuraVentanaRoto(double x, double y, double width, double height, double hitboxX, double hitboxY, double hitboxWidth, double hitboxHeight) {
